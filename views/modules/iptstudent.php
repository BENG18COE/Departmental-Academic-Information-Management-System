                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                <div class="col-md-9">
                                	<h4 class="header-title">IPT Books Marking Section</h4>
                                </div>                   
                                <div class="col-md-3">
                                   ...
                                   <br>
                                    ...
                                    <table id="dataTable"  width="100%">
                                        ...
                                        $settings = SearchInfoCtrl::ShowSearchInfoCtrl($item,$value);
							             ...
							             $studentlist = managedepartsctrl::studentsctrlinclass2show($item,$value); 
                                		...
                                		<td>'.$classname.'</td>                                                                               
                                        <td>
                                        <input class="form-check-input" type="checkbox" name="ipttudentid[]" value="'.$value["id"].'">
                                        </td>
                                        </tr>';
							             }

                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                <div class="col-md-9">
                                	<h4 class="header-title">Final Year Students Supervision</h4>
                                </div>                   
                                <div class="col-md-3">
                                   ...
                                   <br>
                                    ...
                                    <table id="dataTable"  width="100%">
                                        ...
                                        $settings = SearchInfoCtrl::ShowSearchInfoCtrl($item,$value);
							             ...
							             $studentlist = managedepartsctrl::studentsctrlinclassshow($item,$value); 
                                		...
                                		<td>'.$classname.'</td>                                                                               
                                        <td>
                                        <input class="form-check-input" type="checkbox" name="slctstudentid[]" value="'.$value["id"].'">
                                        </td>
                                        </tr>';
							             }

                                ...
                                <div class="data-tables">
                                    ...
                                    <table id="dataTable"  width="100%">
                                        ...
                                        <?php
                                         ...
                                         $item = 'supervison';
							             $value =  $_SESSION["idi"];
							             $studentlist = FinalpresentationCtrl::DepartStudentAllocatedShowCtrl($item,$value); 
							             foreach ($studentlist as $key => $value) {
                                        $itemg = "id";
                                        $valuek = $value["teacherid"];
                                        $tichname = managedepartsctrl::allteacherslistctrlshow($itemg,$valuek); 
                                        ...
                                        <td>'.$tichname["first"].' '.$tichname["secon"].' '.$tichname["third"].'</td>  

        ...
        <div class="main-content-inner">
            <div class="row">
                 ...
                 <div class="card">
                    ...
                    <div class="col-md-6">
                        <label for="exampleInputEmail1">Teacher</label>
                    <select class="form-control selectpicker"  name="exmteacherid" required="" data-live-search="true">
    				...
    				<div class="col-md-6" >
    					<label for="exampleInputEmail1">Module</label>
    				<select class="form-control selectpicker" id="" name="exmoduleid" required="" data-live-search="true">
                    ...
                    <div class="col-md-6">
                        <select class="form-control selectpicker"  name="classidi"  data-live-search="true" required>
                    ...
                    <div class="col-md-6">
                     <input type="text" min="0" class="form-control" name="numberofstudens"  required="" placeholder="Enter Number Of Students " required>        
                    </div>
                    </div>
                    </div>

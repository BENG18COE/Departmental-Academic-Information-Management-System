                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                <div class="col-md-9">
                                	<h4 class="header-title">Exam Script Marking</h4>
                                </div>                   
                                <div class="col-md-3">
                                ...
                                <div class="data-tables">
                                    ...
                                    <table id="dataTable"  width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            $item = null;
                                            $value =  $_SESSION["idi"];
                                            $modules = ExaminationManageCtrl::CheckAssingedCtrLSetCtrl($item,$value); 
...
<?php
    $useradd = new ExaminationManageCtrl();
     $useradd ->DelAssignedScriptExamCtrl();
    ?>
